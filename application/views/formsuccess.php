...
<body>
    ...
    <div style="margin-top: 2rem;">
        ...
        <form action="" method="post" id="ajax_form">
            <div class="container">
                <input type="hidden" name="userId" id="" value="<?= isset($userId) ? $userId : '' ?>">
                <div class="row">
                    <div class="col-25">
                ...
                <div class="row">
                    ...
                    <div class="col-25">
                        <input type="text" id="phone" name="phone" value="<?php echo $phone ?>" placeholder="Your number.." required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                ...
                <div class="row">
                    ...
                    <div class="col-75">
                        <input type="date" id="dob" name="dob" value="<?php echo $dob ?>" placeholder="DOB.." required></input>
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                    ...
                    <div class="col-25">
                        <select name="country" id="country" class="form-control input-lg">
                            <option value="<?php echo $countrycode ?>"><?php echo $countrycc ? $countrycc : "Select Country" ?></option>
                            <?php
                ...
                <div class="row">
                    ...
                    <div class="col-25">
                        <select name="state" id="state" class="form-control input-lg">
                            <option value="<?php echo $statecode ?>"><?php echo $statecc ? $statecc : "Select State" ?></option>
                        </select>
                    </div>
                </div>
                <br />
                <div class="row">
                    ...
                    <div class="col-25">
                        <select name="city" id="city" class="form-control input-lg">
                            <option value="<?php echo $citycode ?>"><?php echo $citycc ? $citycc : "Select City" ?></option>
                        </select>
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        if (Number(localStorage.getItem('edit')) === 1) {
